 ...
 * @since 1.2.0
 */
public class ZWaveEventSubscriberBinding extends AbstractEventSubscriberBinding<ZWaveBindingProvider> implements ManagedService {

	private static final Logger logger = 
		LoggerFactory.getLogger(ZWaveEventSubscriberBinding.class);
	
	
	public ZWaveEventSubscriberBinding() {
	}
